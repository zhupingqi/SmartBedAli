        ...
        if (pattern[i+1] != '\0')
        {
          ...
          switch (pattern[i])
          {
            ...
            default:  
            {
              ...
              re_compiled[j].chccl.ch = pattern[i];
            } break;
          }
        }
...
*/
      ...
      case '[':
      {
        ...
        re_compiled[j].chccl.ccl = &ccl_buf[buf_begin];
      } break;
...
static int matchone(regex_t p, char c)
{
  ...
  {
    case DOT:            return 1;
    case CHAR_CLASS:     return  matchcharclass(c, (const char*)p.chccl.ccl);
    case INV_CHAR_CLASS: return !matchcharclass(c, (const char*)p.chccl.ccl);
